...
InternalMapEntries: ; 71382 (1c:5382)
	...
	IMAP MT_MOON_SHOP,              $6,$2,MountMoonName
	IMAP VERMILION_FERRY_DOCK,      $A,$9,VermilionCityName
	IMAP VICTORY_ROAD_1,            $0,$4,VictoryRoadName
	IMAP SOUTHERN_ISLAND_INSIDE,    $A,$9,AreaUnknownText
	IMAP LANCES_ROOM,               $0,$2,PokemonLeagueName
	IMAP NAVEL_ROCK_CAVE_2,         $A,$9,AreaUnknownText
	...
	IMAP INSIDE_FERRY,              $A,$9,AreaUnknownText
	...
	IMAP NAVEL_ROCK_LUGIA_ROOM,     $A,$9,AreaUnknownText
