SilphCo2Object: ; 0x59e66 (size=98)
	...
	db $5 ; objects
	object SPRITE_DAISY, $a, $1, NONE, UP, $1 ; person
	object SPRITE_OAK_AIDE, $5, $c, NONE, DOWN, $2, SCIENTIST + $C8, $2
	object SPRITE_OAK_AIDE, $18, $d, NONE, LEFT, $3, SCIENTIST + $C8, $3
	object SPRITE_ROCKET, $10, $b, NONE, UP, $4, ROCKET + $C8, $17
	object SPRITE_ROCKET_F, $18, $7, NONE, UP, $5, ROCKET_F + $C8, $18
