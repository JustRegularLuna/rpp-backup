ViridianGymObject:
	...
	db $b ; objects
	object SPRITE_GIOVANNI, $2, $1, STAY, DOWN, $1, OPP_BLAINE, $2 ; temp fix
	object SPRITE_BLACK_HAIR_BOY_1, $c, $7, STAY, DOWN, $2, OPP_COOLTRAINER_M, $9
	object SPRITE_BLACKBELT, $b, $b, STAY, UP, $3, OPP_BLACKBELT, $6
	...
	object SPRITE_BLACKBELT, $a, $1, STAY, DOWN, $7, OPP_BLACKBELT, $8
