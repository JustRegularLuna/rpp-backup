SaffronGymObject: ; 0x5d259 (size=330)
	...
	db $9 ; objects
	object SPRITE_SABRINA, $9, $8, STAY, DOWN, $1, SABRINA + $C8, $1
	object SPRITE_MEDIUM, $a, $1, STAY, DOWN, $2, HEX_MANIAC + $C8, $1
	object SPRITE_BUG_CATCHER, $11, $1, STAY, DOWN, $3, PSYCHIC_TR + $C8, $1
	object SPRITE_MEDIUM, $3, $7, STAY, DOWN, $4, HEX_MANIAC + $C8, $2
	object SPRITE_BUG_CATCHER, $11, $7, STAY, DOWN, $5, PSYCHIC_TR + $C8, $2
	object SPRITE_MEDIUM, $3, $d, STAY, DOWN, $6, HEX_MANIAC + $C8, $3
