ViridianCityObject: ; 0x18384 (size=104)
	...
	object SPRITE_GAMBLER, $1e, $8, NONE, NONE, $2 ; person
	object SPRITE_BUG_CATCHER, $1e, $19, WALK, $0, $3 ; person
	object SPRITE_GIRL, $11, $9, NONE, RIGHT, $4 ; person
	object SPRITE_GAMBLER, $12, $9, NONE, RIGHT, $5 ; person
	object SPRITE_FISHER2, $6, $17, NONE, DOWN, $6 ; person
