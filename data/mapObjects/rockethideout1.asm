RocketHideout1Object: ; 0x44ce7 (size=98)
	...
	db $7 ; objects
	object SPRITE_ROCKET_F, $1a, $8, STAY, LEFT, $1, OPP_ROCKET_F, $8
	object SPRITE_ROCKET, $c, $6, STAY, RIGHT, $2, OPP_ROCKET, $9
	object SPRITE_ROCKET_F, $12, $11, STAY, DOWN, $3, OPP_ROCKET_F, $a
	object SPRITE_ROCKET_F, $f, $19, STAY, RIGHT, $4, OPP_ROCKET_F, $b
