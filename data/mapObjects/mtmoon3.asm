MtMoon3Object: ; 0x49fdb (size=102)
	...
	object SPRITE_ROCKET_F, $b, $10, STAY, DOWN, $2, ROCKET_F + $C8, $1
	object SPRITE_JAMES, $f, $16, STAY, DOWN, $3, ROCKET + $C8, $2
	object SPRITE_JESSIE, $1d, $b, STAY, UP, $4, ROCKET_F + $C8, $3
