FuchsiaCityObject: ; 0x18bd4 (size=178)
	...
	object SPRITE_FISHER2, $1e, $e, NONE, DOWN, $3 ; person
	object SPRITE_BUG_CATCHER, $18, $8, NONE, UP, $4 ; person
	object SPRITE_CLEFAIRY, $1f, $5, WALK, $0, $5 ; person
	object SPRITE_BALL, $19, $6, NONE, NONE, $6 ; person
	object SPRITE_SLOWBRO, $c, $6, WALK, $2, $7 ; person
	object SPRITE_SLOWBRO, $1e, $c, WALK, $2, $8 ; person
	object SPRITE_LAPRAS, $8, $11, WALK, $0, $9 ; person
	object SPRITE_OMANYTE, $6, $5, NONE, NONE, $a ; person
