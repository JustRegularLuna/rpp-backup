VermilionCityObject: ; 0x189ba (size=133)
	...
	object SPRITE_GAMBLER, $e, $6, NONE, NONE, $2 ; person
	object SPRITE_SAILOR, $14, $1c, NONE, UP, $3 ; person
	object SPRITE_GAMBLER, $1e, $7, NONE, NONE, $4 ; person
	...
	EVENT_DISP VERMILION_CITY_WIDTH, $1d, $13 ; VERMILION_DOCK
	EVENT_DISP VERMILION_CITY_WIDTH, $1d, $14 ; VERMILION_DOCK
	EVENT_DISP VERMILION_CITY_WIDTH, $d, $d ; VERMILION_HOUSE_3
	EVENT_DISP VERMILION_CITY_WIDTH, $3, $7 ; VERMILION_HOUSE_2
	EVENT_DISP VERMILION_CITY_WIDTH, $1d, $9 ; VERMILION_FERRY_DOCK
	EVENT_DISP VERMILION_CITY_WIDTH, $1d, $a ; VERMILION_FERRY_DOCK
