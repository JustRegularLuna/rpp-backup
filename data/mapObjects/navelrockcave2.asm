NavelRockCave2Object: ; 0x51a4d (size=68)
	...
	db $b ; warps
	db $21, $7, $2, NAVEL_ROCK_CAVE_1  ;00 Goes to entry room
	db $3, $f, $2, NAVEL_ROCK_CAVE_2   ;01 Top right fork, connects to top right small room
	...
	db $3, $3, $0, $ff                     ; 0A Unused, will warp to Ho-Oh's side later
	...
	; warp-to
	EVENT_DISP NAVEL_ROCK_CAVE_2_WIDTH, $21, $7  ; 00
	EVENT_DISP NAVEL_ROCK_CAVE_2_WIDTH, $3, $f   ; 01
	...
	EVENT_DISP NAVEL_ROCK_CAVE_2_WIDTH, $3, $3   ; 0A
