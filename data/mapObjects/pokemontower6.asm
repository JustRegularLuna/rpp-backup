PokemonTower6Object: ; 0x60c5b (size=58)
	...
	db $5 ; people
	db SPRITE_MEDIUM, $a + 4, $c + 4, $ff, $d3, TRAINER | $1, CHANNELER + TRAINER_START, $13
	db SPRITE_MEDIUM, $5 + 4, $9 + 4, $ff, $d0, TRAINER | $2, CHANNELER + TRAINER_START, $14
	db SPRITE_MEDIUM, $5 + 4, $10 + 4, $ff, $d2, TRAINER | $3, CHANNELER + TRAINER_START, $15
