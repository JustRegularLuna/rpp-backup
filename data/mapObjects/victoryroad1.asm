VictoryRoad1Object: ; 0x5dab8 (size=76)
	...
	db $7 ; objects
	object SPRITE_BRUNETTE_GIRL, $7, $5, NONE, RIGHT, $1, PKMN_TRAINER + $C8, $2
	object SPRITE_BLACK_HAIR_BOY_1, $3, $2, NONE, DOWN, $2, COOLTRAINER_M + $C8, $5
	object SPRITE_BALL, $b, $0, NONE, NONE, $3, TM_15
	object SPRITE_BALL, $9, $2, NONE, NONE, $4, RARE_CANDY
