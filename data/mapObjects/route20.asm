Route20Object: ; 0x50113 (size=106)
	...
	db SPRITE_SWIMMER, $b + 4, $44 + 4, $ff, $d1, TRAINER | $2, SWIMMER_F + TRAINER_START, $f
	db SPRITE_SWIMMER, $a + 4, $2d + 4, $ff, $d0, TRAINER | $3, SWIMMER_F + TRAINER_START, $6
	db SPRITE_SWIMMER, $e + 4, $37 + 4, $ff, $d3, TRAINER | $4, SWIMMER_F + TRAINER_START, $12
	...
	db SPRITE_SWIMMER, $7 + 4, $19 + 4, $ff, $d1, TRAINER | $8, SWIMMER_F + TRAINER_START, $7
	db SPRITE_SWIMMER, $c + 4, $18 + 4, $ff, $d0, TRAINER | $9, SWIMMER_F + TRAINER_START, $11
	db SPRITE_SWIMMER, $8 + 4, $f + 4, $ff, $d1, TRAINER | $a, SWIMMER_F + TRAINER_START, $8
