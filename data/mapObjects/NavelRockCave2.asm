NavelRockCave2Object:
	...
	db $f, $23, $0, NAVEL_ROCK_LUGIA_ROOM  ;05 Down Stairs in middle right room, connects to Lugia Chamber
	db $1b, $23, $1, NAVEL_ROCK_LUGIA_ROOM ;06 Up Stairs in bottom right room, connect to Ho-Oh Chamber
	...
	db $1b, $15, $a, NAVEL_ROCK_CAVE_2     ;09 Connects to Ho-Oh's fork
	db $2, $2, $9, NAVEL_ROCK_CAVE_2       ;0A warp to Ho-Oh's side
