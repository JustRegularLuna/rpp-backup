...
KogaData:
	db $FF,37,VENOMOTH,39,MUK,37,CROBAT,43,WEEZING,0
	
BlaineData:
	db $FF,42,GROWLITHE,40,PONYTA,42,RAPIDASH,45,ARCANINE,47,MAGMAR,0
	
SabrinaData:
	db $FF,38,KADABRA,37,MR_MIME,38,ESPEON,43,ALAKAZAM,0
	
GiovanniData:
	db $FF,25,ONIX,24,RHYHORN,29,KANGASKHAN,0
	db $FF,35,ONIX,37,RHYHORN,37,NIDORINO,41,NIDOQUEEN,0
	db $FF,45,RHYDON,42,STEELIX,44,NIDOQUEEN,45,NIDOKING,50,RHYPERIOR,0
	
LoreleiData:
	db $FF,54,DEWGONG,53,CLOYSTER,54,SLOWKING,56,JYNX,56,LAPRAS,0
	
BrunoData:
	db $FF,53,ONIX,55,HITMONCHAN,55,HITMONLEE,56,STEELIX,58,MACHAMP,0	
	
AgathaData:
	db $FF,56,MISDREAVUS,56,HONCHKROW,55,HOUNDOOM,58,MISMAGIUS,60,GENGAR,0
	
LanceData:
	db $FF,58,GYARADOS,56,CHARIZARD,56,KINGDRA,60,AERODACTYL,62,DRAGONITE,0	
...
PokemaniacData:
	...
	db $FD,COSPLAY_GIRL,22,PIKACHU,CUBONE,0
	db 25,SLOWPOKE,0
	db 40,CHARMELEON,LAPRAS,LICKITUNG,0
	db 23,CUBONE,SLOWPOKE,0
	
SuperNerdData:
	db 11,VOLTORB,VOLTORB,0
	db 16,PIKACHU,EEVEE,0
...
HikerData:
	...
	db 13,GEODUDE,MANKEY,MACHOP,0
	db 17,DIGLETT,ONIX,0
...
BikerData:
	db 28,KOFFING,GRIMER,EKANS,0
	db 29,RHYHORN,RHYHORN,0
	db 25,KOFFING,GRIMER,0
	db 28,GRIMER,SLUGMA,0
	db 29,GRIMER,KOFFING,0
	db 33,DITTO,0
	db 26,GRIMER,GRIMER,GRIMER,GRIMER,0
	db 28,WEEZING,KOFFING,WEEZING,0
	db 33,MUK,0
	db 29,VOLTORB,MAGNEMITE,0
	db 29,HOUNDOUR,MURKROW,0
	db 25,KOFFING,WEEZING,KOFFING,KOFFING,WEEZING,0
	db 26,KOFFING,KOFFING,GRIMER,KOFFING,0
	db 28,SLUGMA,SLUGMA,KOFFING,0
	db 29,MURKROW,MUK,0
...
EngineerData:
	db 21,MAGNEMITE,PIKACHU,0
	db 21,MAGNEMITE,CHINCHOU,0
	db 18,MAGNEMITE,PIKACHU,0
...
SwimmerData:
	...
	db 32,CHINCHOU,LANTURN,STARMIE,0
...
BeautyData:
	...
	db 19,GOLDEEN,0 ; Misty's Gym, Trainer # 0x10
	db 30,TENTACOOL,HORSEA,SEEL,0 ; Route 20, Trainer # 0x11
	db 31,GOLDEEN,SEAKING,0 ; Route 20, Trainer # 0x12
	
PsychicData:
	db 31,KADABRA,SLOWPOKE,MR_MIME,KADABRA,0
	db 34,MR_MIME,KADABRA,0
	db 33,SLOWPOKE,SLOWBRO,SLOWKING,0
	db 38,SLOWKING,0
	
RockerData:
	db $FD,ROCKER_F,20,VOLTORB,VOLTORB,VOLTORB,0
...
BirdKeeperData:
	...
	db 26,MURKROW,SPEAROW,MURKROW,FEAROW,0
	db 29,PIDGEOTTO,FEAROW,0
	db 28,SPEAROW,MURKROW,FEAROW,0
...
RocketFData:
RocketData:
	db $FD,EXECUTIVE_F,15,RATTATA,ZUBAT,0
	db 11,SANDSHREW,RATTATA,ZUBAT,0
	db 13,ZUBAT,EKANS,0
	db 14,RATICATE,0
	db 17,MACHOP,DROWZEE,0
	db $FD,PI_TRAINER,15,EKANS,ZUBAT,0 ; Nugget Bridge "Boss"
	...
	db $FD,EXECUTIVE_M,23,ZUBAT,RATTATA,RATICATE,ZUBAT,0
