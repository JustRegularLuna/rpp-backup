...
PokemaniacData:
	...
	db "JESSY@",SPECIAL_TRAINER3,COSPLAY_GIRL,22,PIKACHU,CUBONE,$FF
...
RockerData:
	db "DEBBIE@",SPECIAL_TRAINER3,ROCKER_F,20,VOLTORB,VOLTORB,VOLTORB,$FF
...
RocketFData:
RocketData:
	db "EXECUTIVE@",SPECIAL_TRAINER3,EXECUTIVE_F,15,RATTATA,MURKROW,$FF
	db "JAMES@",SPECIAL_TRAINER3,JAMES,13,KOFFING,$FF
	db "JESSIE@",SPECIAL_TRAINER3,JESSIE,13,EKANS,$FF
	db "GRUNT@",14,RATICATE,$FF
	db "GRUNT@",17,MACHOP,DROWZEE,$FF
	db "GRUNT@",SPECIAL_TRAINER3,PI_TRAINER,15,EKANS,ZUBAT,$FF ; Nugget Bridge "Boss"
	...
	db "JAMES@",SPECIAL_TRAINER3,JAMES,23,WEEZING,WEEPINBELL,$FF ; James in Game Corner
	db "JESSIE@",SPECIAL_TRAINER3,JESSIE,23,ARBOK,LICKITUNG,$FF ; Jessie in Game Corner
	db "GRUNT@",21,KOFFING,ZUBAT,$FF
	db "GRUNT@",25,ZUBAT,ZUBAT,GOLBAT,$FF
	db "GRUNT@",26,KOFFING,DROWZEE,$FF
	db "EXECUTIVE@",SPECIAL_TRAINER3,EXECUTIVE_M,23,ZUBAT,RATTATA,RATICATE,ZUBAT,$FF
	...
	db "EXECUTIVE@",SPECIAL_TRAINER3,EXECUTIVE_M,34,CUBONE,DROWZEE,MAROWAK,$FF
