...
YoungsterData: ; COMPLETED
	...
	db 23,SPEAROW,RATTATA,RATTATA,SPEAROW,0 ; 					UNKNOWN
...
PokemaniacData: ; COMPLETED
	...
	db $FD,COSPLAY_GIRL,36,RAICHU,MAROWAK,0 ; ROCKTUNNEL 4
...
CoupleData: ; COMPLETED
	db 25,CUBONE,WEEPINBELL,0 ; route 6
...
RockerData: ; COMPLETED
	db $FD,ROCKER_F,35,VOLTORB,ELECTRODE,0 ; LT LURGE GYM
...
TamerData: ; COMPLETED
	...
	db 62,RHYHORN,PRIMEAPE,ARBOK,TAUROS,0 ;  		UNKNOWN
...
BirdKeeperData: ; COMPLETED
	...
	db 52,FARFETCH_D,FEAROW,0 ;                                UNKNOWN
...
RocketData: ; COMPLETED
	db $FD,EXECUTIVE_F,18,RATTATA,ZUBAT,KOFFING,0 ; MT MOON
	...
	db $FD,PI_TRAINER,21,RATICATE,GOLBAT,ARBOK,0 ; NUGGET BRIDGE FINALE
	...
	db $FD,EXECUTIVE_M,50,RATICATE,0 ; PKMNTOWER 3
