...
; if first byte == SPECIAL_TRAINER2, then
	...
	; each Pokemon entry is Level, Species, Moveset
	; FF-terminated
; if first byte == SPECIAL_TRAINER3, then
	; second byte is custom sprite number
...
Green1Data:
	...
	; Beside Viridian
	db "[RIVAL]@",10,EEVEE,RATTATA,PIDGEY,SQUIRTLE,$FF
	db "[RIVAL]@",10,EEVEE,RATTATA,PIDGEY,BULBASAUR,$FF
	db "[RIVAL]@",10,EEVEE,RATTATA,PIDGEY,CHARMANDER,$FF
...
LassData: ; COMPLETED
	...
	db "ROSE@",25,PIDGEOTTO,NIDORINA,$FF ; SSANNE
...
CamperData: 
	...
	db "NICK@",32,GROWLITHE,CHARMELEON,$FF ; Route 9 3u
...
PokemaniacData: ; COMPLETED
	...
	db "JESSY@",SPECIAL_TRAINER3,COSPLAY_GIRL,36,RAICHU,MAROWAK,$FF ; ROCKTUNNEL 4
...
BurglarData: ; COMPLETED
	...
	db "DARRYL@",61,NINETALES,FLAREON,$FF ; CINNABAR GYM 4
...
RockerData: ; COMPLETED
	db "DEBBIE@",SPECIAL_TRAINER3,ROCKER_F,35,VOLTORB,ELECTRODE,$FF ; LT LURGE GYM
...
JugglerData: ; COMPLETED
	...
	db "FRITZ@",56,HYPNO,ALAKAZAM,$FF ; FUSIA GYM 2R
	db "LIAM@",56,HYPNO,ALAKAZAM,$FF ; FUSIA GYM 4M
	db "CLOYD@",64,MR_MIME,$FF ; VICTORYROAD 2 4
	db "DEREK@",53,HYPNO,$FF ;                                  UNKNOWN
	db "WILL@",55,HYPNO,$FF ; FUSIA GYM 1R
	db "SHAWN@",55,HYPNO,ALAKAZAM,$FF ; FUSIA GYM 1L
	
TamerData: ; COMPLETED
	db "COLE@",56,SANDSLASH,ARBOK,$FF ; FUSIA GYM 4TL
	db "EDGAR@",56,ARBOK,SANDSLASH,ARBOK,$FF ; FUSIA GYM 3R
...
RocketData: ; COMPLETED
	db "EXECUTIVE@",SPECIAL_TRAINER3,EXECUTIVE_F,18,RATTATA,MURKROW,KOFFING,$FF ; MT MOON
	db "JAMES@",SPECIAL_TRAINER3,JAMES,17,KOFFING,BELLSPROUT,$FF ; MT MOON
	db "JESSIE@",SPECIAL_TRAINER3,JESSIE,17,EKANS,LICKITUNG,$FF ; MT MOON
	db "GRUNT@",17,RATTATA,ZUBAT,EKANS,$FF ; MT MOON
	db "GRUNT@",25,MACHOKE,DROWZEE,$FF ; CERULEAN BACK OF HOUSE
	db "GRUNT@",SPECIAL_TRAINER3,PI_TRAINER,21,RATICATE,GOLBAT,ARBOK,$FF ; NUGGET BRIDGE FINALE
	...
	db "JAMES@",SPECIAL_TRAINER3,JAMES,43,WEEZING,VICTREEBEL,$FF ; GC B4 James Battle
	db "JESSIE@",SPECIAL_TRAINER3,JESSIE,43,ARBOK,LICKITUNG,$FF ; GC B4 Jessie Battle
	db "GRUNT@",43,WEEZING,MUK,GOLBAT,$FF ; GC B4
	db "GRUNT@",50,CROBAT,$FF ; PKMNTOWER 1
	db "GRUNT@",50,WEEZING,HYPNO,$FF ; PKMNTOWER 2
	db "EXECUTIVE@",SPECIAL_TRAINER3,EXECUTIVE_M,50,RATICATE,$FF ; PKMNTOWER 3
	...
	db "EXECUTIVE@",SPECIAL_TRAINER3,EXECUTIVE_M,50,HYPNO,MAROWAK,$FF ; SILPHCO 13 1
