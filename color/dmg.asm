...
; There's a copy of the audio engine in bank DMG_SOUND_ENGINE that's used for this, hasn't been
...
.codeCopyLoop
	...
	; Use sound engine copy in bank DMG_SOUND_ENGINE
	ld a,DMG_SOUND_ENGINE
